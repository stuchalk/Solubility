<?php $systems=$data['System'];$type=$data['Systemtype']; ?>
...
?>
<p>&nbsp;<br />
<?php echo "Information obtained from ".$this->Html->link('The NIST Solubility Database','http://srdata.nist.gov/solubility/sol_sys_lst.aspx?sysID='.$system['sysID'].'&FROM=SSN',array('target'=>'_blank'));?></p>